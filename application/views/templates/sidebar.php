...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Charts -->
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('categori/elektronik');?>">
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('categori/pakaian_pria');?>">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Pakaian Pria</span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('categori/pakaian_wanita');?>">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Pakaian Wanita</span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('categori/pakaian_anak_anak');?>">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Pakaian Anak Anak</span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('categori/peralatan_olahraga');?>">
                    <i class="fas fa-fw fa-table"></i>
